...
import com.hrj.mojian.utils.ImageUtils;
...
//							mojianService.setappName("appName4", appName4);
    ...
    private void bindService() {
        Intent intent = new Intent("com.hrj.mojian.MojianService");
...
//	    		mojianService.setappName("appName4", appName4);
    ...
    private void setSharedPreference(String key, String value) {
        SharedPreferences.Editor editor = getSharedPreferences("COM_hrj_MOJIAN", MODE_WORLD_WRITEABLE).edit();
        editor.putString(key, value);
        editor.commit();
    }

    private String getSharedPreference(String key) {
        SharedPreferences pre = getSharedPreferences("COM_hrj_MOJIAN", MODE_WORLD_READABLE);
